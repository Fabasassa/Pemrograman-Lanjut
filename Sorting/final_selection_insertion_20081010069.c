...
int main()
{
    ...
    char muter = 'y';
    int pilih, siswa, data, ubah, hapus, a, b, i, j, k;
...
menu:
    ...
    else if (pilih == 5)
    {
        ...
        printf("Opsi sorting: ");
        printf("\n1. NPM (insertion ascending)");
        printf("\n2. NPM (insertion descending)");
        printf("\n3. Nama (isnertion ascending)");
        printf("\n4. Nama (insertion descending)");
        printf("\n5. NPM (selection ascending)");
        printf("\n6. NPM (selection descending)");
        printf("\n7. Nama (selection ascending)");
        printf("\n8. Nama (selection descending)");
        ...
        if (sort == 1)
        {
            ...
            {
                j = i;
                while (j > 0 && strcmp(maha[j - 1].npm, maha[j].npm) > 0)
                {
                    insertion(j);
                    j--;
                }
        ...
        else if (sort == 3)
        {
            ...
            {
                j = i;
                while (j > 0 && strcmp(maha[j - 1].nami, maha[j].nami) > 0)
                {
                    insertion(j);
                    j--;
                }
        ...
        if (sort == 5)
        {
            ...
            for (i = 0; i < siswa; i++)
            {
                ...
                for (k = i + 1; k < siswa; k++)
                {
                    if (strcmp(maha[j].npm, maha[k].npm) == 1)
                        j = k;
                }
                if (j != i)
                {
        ...
        if (sort == 7)
        {
            ...
            for (i = 0; i < siswa; i++)
            {
                ...
                for (k = i + 1; k < siswa; k++)
                {
                    if (strcmp(maha[j].nami, maha[k].nami) == 1)
                        j = k;
                }
                if (j != i)
                {
...
void selection(int i, int j)
{
    ...
    strcpy(temp[0], maha[j].npm);
    strcpy(maha[j].npm, maha[i].npm);
    strcpy(maha[i].npm, temp[0]);

    strcpy(temp[0], maha[j].nami);
    strcpy(maha[j].nami, maha[i].nami);
    strcpy(maha[i].nami, temp[0]);
}